...
ALOHA_X5A_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "right_arm": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                "right_joint1": 87.0,
                "right_joint[2-6]": 87.0,
            },
            velocity_limit_sim=1.57,
            stiffness={"right_joint1": 400.0, "right_joint[2-6]": 400.0},
            damping={"right_joint1": 80.0, "right_joint[2-7]": 80.0},
        ),
        "right_gripper": ImplicitActuatorCfg(
            joint_names_expr=["right_joint[7-8]"],
            effort_limit_sim={"right_joint[7-8]": 100.0},
            velocity_limit_sim=10.0,
            stiffness={"right_joint[7-8]": 400.0},
            damping={"right_joint[7-8]": 80.0},
        ),
    },
