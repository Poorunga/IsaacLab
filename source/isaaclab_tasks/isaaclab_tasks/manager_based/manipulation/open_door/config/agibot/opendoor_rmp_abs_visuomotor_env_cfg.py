...
@configclass
class AgibotOpenDoorVisuomotorEnvCfg(opendoor_rmp_abs_env_cfg.AgibotOpenDoorEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.left_cam = CAMERA_CFG.copy()
        ...
        self.scene.right_cam = CAMERA_CFG.copy()
